...
<p align="center">
  <a href="https://auto.gluon.ai/" title="AutoGluon">
    <img src="https://img.shields.io/badge/AutoGluon-FF9900?style=for-the-badge&logo=amazonaws&logoColor=white" alt="AutoGluon" height="35">
  </a>
  <a href="https://evidentlyai.com/" title="Evidently AI">
    <img src="https://img.shields.io/badge/Evidently_AI-00D1B2?style=for-the-badge&logo=python&logoColor=white" alt="Evidently AI" height="35">
  </a>
...
<p align="center">
  ...
  <a href="https://github.com/astral-sh/uv" title="uv">
    <img src="https://img.shields.io/badge/uv-DE5FE9?style=for-the-badge&logo=python&logoColor=white" alt="uv" height="35">
  </a>
  ...
  <a href="https://github.com/astral-sh/ruff" title="Ruff">
    <img src="https://img.shields.io/badge/Ruff-D7FF64?style=for-the-badge&logo=ruff&logoColor=black" alt="Ruff" height="35">
...
```mermaid
graph LR
    A[Data Ingestion<br/>Kaggle API] --> B[Preprocessing<br/>Binary Target Creation]
    B --> C[Train Baseline<br/>Model v1]
    C --> D[Drift Detection<br/>KS Test + Evidently]
    D --> E{Drift > 0.05?}
    E -->|Yes| F[Retrain<br/>Model v2]
    E -->|No| G[Model Stable]
    F --> H[MLflow Registry<br/>Version Comparison]
    G --> H
    H --> I[FastAPI Serving<br/>Auto-Fill Missing Values]
    I --> J[Streamlit Dashboard<br/>Metrics + Predictions]
